...
export async function minhasEscolinhas() {
  ...
  const linhas = await exec(
    supabase
      .from('membros')
      .select('papel, escolinha:escolinhas(id, nome, cidade, local_padrao, chave_pix, razao_social, documento, dia_vencimento, tolerancia_atraso, codigo_matricula, matriculas_abertas)')
